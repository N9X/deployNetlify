        ...
        import headerblack from "/assets/headerblack.component.637988782772750000.js";import position from "/assets/position.component.637988782772750000.js";
        ...
        window.TEZ_DATA =  function(registerTezPage,preload){
            const payload = {"url":"/position","slots":{"default":[{"name":"position","data":{"componentName":"position"},"id":"0-position"}]},"masterPageSlots":{"header":[{"name":"headerblack","data":{"componentName":"headerblack"},"id":"0-headerblack"}],"footer":[{"name":"footer","data":{"componentName":"footer"},"id":"1-footer"}]},"tags":{"title":"Finsanity","canonical":"http://localhost:3000/position","metaTag":{"name":{"description":"Finsanity"}}},"layoutName":"custom-layout"}; 
            registerTezPage({
                components:{"headerblack":headerblack,"position":position,},
